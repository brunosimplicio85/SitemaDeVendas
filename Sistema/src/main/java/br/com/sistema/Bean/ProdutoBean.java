...
public class ProdutoBean implements Serializable {
	...
	private ArrayList<Produto> protudosFiltrados;
	...
	public ArrayList<Produto> getProtudosFiltrados() {
		return protudosFiltrados;
	}
	
	public void setProtudosFiltrados(ArrayList<Produto> protudosFiltrados) {
		this.protudosFiltrados = protudosFiltrados;
	}
	...
	public void editar(ActionEvent evento){
		try {
			...
			produto.setCaminho("C:/Imagens/" + produto.getDescricao() + ".jpg");
	...
	public void salvar() {
		try {
			...
			Path destino = Paths.get("C:/Imagens/" + produtoRetorno.getDescricao() + ".jpg");
	...
	public void excluir(ActionEvent evento) {
		try {
			...
			Path arquivo = Paths.get("C:/Imagens/" + produto.getDescricao() + ".jpg");
	...
	public void imprimir() {
		try {
			...
			String forDescricao = (String) filtros.get("fornecedor.nome");
